...
?>
        ...
        $(function () {
            ...
            $.get("getCity.php", function (result) {
                ...
                for (i in data) {
                    var eachrow = "<tr onclick=\"displayInfo(" + data[i].cid + ", " + data[i].cpop + ")\"><td>" + data[i].cname + "</td><td>" + data[i].cpop + "</td><td><img src='image/report.png' width='25px' height='25px'></td></tr>";
